...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python vm_behavioral_monitor.py RansomwareSimulator.exe C:/Users/User/Downloads/RANSOMWARE_TEST_FOLDER")
        sys.exit(1)
    
    target_exe = sys.argv[1]
    watch_dir = sys.argv[2] if len(sys.argv) > 2 else "C:/Users/User/Downloads/RANSOMWARE_TEST_FOLDER"
